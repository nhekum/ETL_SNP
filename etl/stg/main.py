...
from etl.stg.common import base_job
...
def thread(init_spark:object, info_dag:object, dst_config:dict, param_config:dict, 
    ...
    try:
        base_job(init_spark=init_spark, info_dag=info_dag, dst_config=dst_config, 
                 param_config=param_config, etl_date=etl_date, parallel=parallel)

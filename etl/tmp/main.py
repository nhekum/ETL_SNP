...
def thread(init_spark:object, base_job:object, info_dag:object, dst_config:dict, param_config:dict, src_config:dict,
    ...
    try:
        base_job(init_spark=init_spark, info_dag=info_dag, stg_config=src_config, 
                 param_config=param_config, tmp_config=dst_config ,etl_date=etl_date, parallel=parallel)
...
# def multithread(init_spark:object, list_job:list, info_dag:object, dst_config:dict, param_config:dict, hook:object):
#     # Get list param
#     parallel = True
...
#         etl_task = {executor.submit(thread, init_spark, dag_config, dst_config, param_config, hook, 

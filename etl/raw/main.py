...
from etl.raw.common import base_job
...
def thread(init_spark:object, info_dag:object, src_config:dict, param_config:dict, 
    ...
    try:
        base_job(init_spark=init_spark, info_dag=info_dag, src_config=src_config, 
...
def multithread(init_spark:object, list_job:list, info_dag:object, src_config:dict, param_config:dict, hook:object):
    # Get list param
    parallel = True
    ...
    with concurrent.futures.ThreadPoolExecutor(max_workers=15) as executor:
        etl_task = {executor.submit(thread, init_spark, dag_config, src_config, param_config, hook, 
